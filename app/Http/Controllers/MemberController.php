...
class MemberController extends Controller
{
    ...
    public function show($id)
    {
        ...
        $radarData = [
            'singing'      => optional($member->skill)->singing ?? 50,
            'dancing'      => optional($member->skill)->dancing ?? 50,
            'variety'      => optional($member->skill)->variety ?? 50,
            'intelligence' => optional($member->skill)->intelligence ?? 50,
            'sport'        => optional($member->skill)->sport ?? 50,
            'burikko'      => optional($member->skill)->burikko ?? 50,
        ];
